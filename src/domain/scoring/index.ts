...
export function computeScoreFromElapsedMs(elapsedMs: number): number {
...
export function computeScoreFromServerTimes(roundStartMs: number, serverReceivedAtMs: number): number {
